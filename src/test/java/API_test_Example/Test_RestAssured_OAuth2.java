...
public class Test_RestAssured_OAuth2 {
	...
	public void authStatus_Code() {
		...
		.auth()
		.oauth2("7d1739364d504c461bf404518318c52945097990")
		.post("http://coop.apps.symfonycasts.com/api/3725/chickens-feed");
		
		System.out.println("Code "+resp.getStatusCode());
		System.out.println("Json Body :"+resp.getBody().toString());
